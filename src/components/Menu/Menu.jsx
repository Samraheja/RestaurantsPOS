...
const {
    categoryLabel, subcategoryLabel, editLabel, deleteLabel, itemCodeLabel, nameLabel, tablePriceLabel, vegNonVegLabel
} = localizedStrings;
                        ...
                        <Card className="shadow">
                            ...
                            <Table className="align-items-center table-flush" responsive>
                                ...
                                <tr>
                                    ...
                                    <th scope="col" className="Header"
                                        onClick={() => props.SortRecords("TablePrice")}>{tablePriceLabel}</th>
                                    <th scope="col" className="Header"
