...
const {
    signUpTitle, iAgreeLink, iAgreeTitle, registerLabel, loginLabel, alreadyHaveAccount
} = localizedStrings;
                      ...
                      <span className="text-muted">
                        ...
                        <Row className="mt-3">
                            <Col className="text-center" xs="12">
                                <span className="text-red mr-1"> {alreadyHaveAccount}</span>
                                <a
                                    href="#sahil"
                                    onClick={(e) => {
                                        e.preventDefault();
